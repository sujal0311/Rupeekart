    ...
    return (
        <div className='container mx-auto px-4 my-6 relative'>
            ...
            <div className='flex items-center gap-4 md:gap-6 overflow-x-scroll scrollbar-none transition-all' ref={scrollElement}>
                ...
                <button aria-label="Scroll Right" className='bg-white shadow-md rounded-full p-1 absolute right-[-20px] text-lg hidden md:block' onClick={scrollRight}>
                    <FaAngleRight />
                </button>
                        ...
                        <Link key={product?._id} to={"product/" + product?._id} className='w-full min-w-[280px] md:min-w-[320px] max-w-[280px] md:max-w-[320px] bg-white rounded-sm shadow '>
                            ...
                            <div className='p-4 grid gap-3'>
                                ...
                                <p className='capitalize text-slate-500'>{product?.category}</p>
                                    <p className='text-blue-600 text-lg font-bold'>{displayINRCurrency(product?.sellingPrice)}</p>
                                <div className='flex gap-3'>
